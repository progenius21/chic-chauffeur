...
export default function Home() {
  return (
    <div className="min-h-screen">
        ...
        <Container>
          <div className="max-w-4xl mx-auto text-center relative z-10 px-4 sm:px-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
              <Button size="lg" className="text-base sm:text-lg px-6 sm:px-8 md:px-10 w-full sm:w-auto">Book Your Journey</Button>
              <Button variant="secondary" size="lg" className="text-base sm:text-lg px-6 sm:px-8 md:px-10 w-full sm:w-auto">Learn More</Button>
            </div>
            {/* Simple Chrome Script */}
            <div className="mt-8 sm:mt-10 md:mt-12 text-center">
              <h3 className="text-2xl sm:text-3xl md:text-4xl italic font-serif" style={{ color: '#d4af37' }}>Coupé</h3>
            </div>
          </div>
        </Container>
      </section>
        ...
        <Container>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 sm:mb-16 px-4">
              <h2 className="text-2xl sm:text-3xl md:text-4xl text-navy mb-4 sm:mb-6">Our Distinguished Services</h2>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
              <div className="text-center group px-4 sm:px-0">
                ...
                <h3 className="text-lg sm:text-xl text-navy mb-3 sm:mb-4">Executive Transport</h3>
              ...
              <div className="text-center group px-4 sm:px-0">
                ...
                <h3 className="text-lg sm:text-xl text-navy mb-3 sm:mb-4">Special Occasions</h3>
                <p className="text-sm sm:text-base text-warm-grey leading-relaxed source-serif-text">
              ...
              <div className="text-center group px-4 sm:px-0 sm:col-span-2 md:col-span-1">
                ...
                <h3 className="text-lg sm:text-xl text-navy mb-3 sm:mb-4">Heritage Tours</h3>
                <p className="text-sm sm:text-base text-warm-grey leading-relaxed source-serif-text">
      ...
      {/* Heritage Story */}
      <section id="heritage" className="py-16 sm:py-20 md:py-24 bg-cream relative overflow-hidden">
        {/* Subtle background branding */}
        <div className="absolute top-16 sm:top-20 right-4 sm:right-10 opacity-30">
          <span className="text-3xl sm:text-4xl md:text-5xl italic font-serif" style={{ color: '#d4af37' }}>Coupé</span>
        </div>
        <Container>
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
              <div className="px-4 sm:px-0">
                <h2 className="text-2xl sm:text-3xl md:text-4xl text-navy mb-4 sm:mb-6">A Legacy of Excellence</h2>
                ...
                <div className="mt-6 sm:mt-8">
                  <Button variant="secondary" className="w-full sm:w-auto">Discover Our Story</Button>
                </div>
              </div>
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-classic shadow-sm">
                ...
                <div className="mt-4 sm:mt-6 text-center">
                  <h3 className="text-base sm:text-lg text-navy mb-2">Master Craftsmanship</h3>
      ...
      <section id="fleet" className="py-16 sm:py-20 md:py-24 bg-white">
        <Container>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 sm:mb-16 px-4">
              <h2 className="text-2xl sm:text-3xl md:text-4xl text-navy mb-4 sm:mb-6">The Rover P5B</h2>
              <p className="text-base sm:text-lg text-warm-grey max-w-2xl mx-auto source-serif-text">
            ...
            <div className="bg-cream rounded-classic p-6 sm:p-8 md:p-12">
              ...
              <div className="text-center mb-6 sm:mb-8">
                <div className="inline-flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-4 bg-navy/5 px-4 sm:px-6 md:px-8 py-4 rounded-classic">
                  ...
                  <div className="text-center sm:text-left">
                    <p className="text-navy text-sm sm:text-base md:text-lg font-semibold source-serif-text">THE PROFESSIONAL CHAUFFEUR SERVICE</p>
                    <p className="text-warm-grey text-xs sm:text-sm source-serif-text">LONDON COUPES.COM</p>
                    <p className="text-gold text-xs sm:text-sm font-medium">ROVER P5B</p>
                  </div>
                </div>
              </div>
              ...
              <div className="aspect-video bg-navy/5 rounded-classic mb-6 sm:mb-8 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4">
                  <p className="text-cream text-lg sm:text-xl source-serif-text font-semibold drop-shadow-lg">Distinguished Rover P5B Service</p>
                  <p className="text-cream/90 mt-2 text-sm sm:text-base source-serif-text drop-shadow-md">Experience Classic British Luxury</p>
                </div>
              </div>
      ...
      {/* Contact & Booking */}
      <section id="contact" className="py-16 sm:py-20 md:py-24 bg-navy text-cream">
        <Container>
          <div className="max-w-4xl mx-auto text-center px-4">
            <h2 className="text-2xl sm:text-3xl md:text-4xl mb-4 sm:mb-6">Begin Your Journey</h2>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-10 md:mb-12">
              <div>
                ...
                <p className="text-sm sm:text-base text-cream/80 source-serif-text">+44 20 7XXX XXXX</p>
              </div>
              <div>
                <h3 className="text-base sm:text-lg mb-2 sm:mb-3">Email</h3>
                <p className="text-sm sm:text-base text-cream/80 source-serif-text">enquiries@londoncoupes.com</p>
              </div>
              <div className="sm:col-span-2 md:col-span-1">
                <h3 className="text-base sm:text-lg mb-2 sm:mb-3">Location</h3>
                <p className="text-sm sm:text-base text-cream/80 source-serif-text">Central London, UK</p>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <Button size="lg" className="bg-cream text-navy hover:bg-cream/90 w-full sm:w-auto">Book Your Journey</Button>
              <Button variant="secondary" size="lg" className="border-cream text-cream hover:bg-cream/10 w-full sm:w-auto">
                Request Quote
              </Button>
            </div>
          </div>
          ...
          <div className="text-center px-4">
            <div className="flex items-center justify-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-cream/60 uppercase tracking-wider hidden sm:block">Distinguished Service</p>
              </div>
            </div>
            <div className="border-t border-cream/20 pt-4 sm:pt-6">
              <div className="flex items-center justify-center space-x-4 mb-2 sm:mb-3">
                <span className="text-xl sm:text-2xl italic font-serif" style={{ color: '#d4af37' }}>Coupé</span>
              </div>
